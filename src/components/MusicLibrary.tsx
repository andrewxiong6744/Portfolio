    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button 
          variant="ghost" 
          size="sm" 
          className="fixed top-4 left-4 z-50 backdrop-blur-sm transition-all duration-200 hover:scale-105 hover:shadow-lg"
          style={{
      ...
      <SheetContent side="left" className="w-full sm:max-w-md">
        <SheetHeader>
          ...
          <SheetDescription>
            Browse and play songs from your music library
          </SheetDescription>
        </SheetHeader>
