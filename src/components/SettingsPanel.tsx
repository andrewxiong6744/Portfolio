    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button 
          variant="ghost" 
          size="sm" 
          className="fixed top-4 right-4 z-50 w-10 h-10 p-0 rounded-full backdrop-blur-sm transition-all duration-200 hover:scale-110 hover:shadow-lg"
          style={{
      ...
      <SheetContent className="w-full sm:max-w-md">
        <SheetHeader>
          ...
          <SheetDescription>
            Customize your music player preferences
          </SheetDescription>
        </SheetHeader>
